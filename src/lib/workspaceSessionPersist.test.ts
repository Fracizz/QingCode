...
describe('buildWorkspaceSessionSnapshot', () => {
  ...
  it('persists dual/田 pane terminal bindings per project', () => {
    const snapshot = buildWorkspaceSessionSnapshot({
      ...
      terminals: [
        { id: 'tl', name: 'TL', projectId: 'p1', cwd: 'D:/proj', launchCommand: '', pane: 'primary' },
        { id: 'tr', name: 'TR', projectId: 'p1', cwd: 'D:/proj', launchCommand: '', pane: 'secondary' },
        { id: 'bl', name: 'BL', projectId: 'p1', cwd: 'D:/proj', launchCommand: '', pane: 'bl' },
        { id: 'br', name: 'BR', projectId: 'p1', cwd: 'D:/proj', launchCommand: '', pane: 'br' },
      ],
